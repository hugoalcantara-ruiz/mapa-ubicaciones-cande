...
var format_Ubicacionesrecientes_4 = new ol.format.GeoJSON();
var features_Ubicacionesrecientes_4 = format_Ubicacionesrecientes_4.readFeatures(json_Ubicacionesrecientes_4, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:4326'});
var jsonSource_Ubicacionesrecientes_4 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Ubicacionesrecientes_4.addFeatures(features_Ubicacionesrecientes_4);
cluster_Ubicacionesrecientes_4 = new ol.source.Cluster({
  distance: 30,
  source: jsonSource_Ubicacionesrecientes_4
});
var lyr_Ubicacionesrecientes_4 = new ol.layer.Vector({
                declutter: false,
                source:cluster_Ubicacionesrecientes_4, 
                style: style_Ubicacionesrecientes_4,
                popuplayertitle: 'Ubicaciones recientes',
                interactive: true,
                title: '<img src="styles/legend/Ubicacionesrecientes_4.png" /> Ubicaciones recientes'
            });

lyr_OpenStreetMap_0.setVisible(true);lyr_GoogleSatellite_1.setVisible(true);lyr_municipios_wgs84_2.setVisible(true);lyr_Departamento_wgs84_3.setVisible(true);lyr_Ubicacionesrecientes_4.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_GoogleSatellite_1,lyr_municipios_wgs84_2,lyr_Departamento_wgs84_3,lyr_Ubicacionesrecientes_4];
...
lyr_Ubicacionesrecientes_4.set('fieldAliases', {'Tipo de pr': 'Tipo de pr', 'Dirección': 'Dirección', 'Telefono': 'Telefono', 'Imagen': 'Imagen', });
...
lyr_Ubicacionesrecientes_4.set('fieldImages', {'Tipo de pr': 'TextEdit', 'Dirección': 'TextEdit', 'Telefono': 'TextEdit', 'Imagen': 'TextEdit', });
...
lyr_Ubicacionesrecientes_4.set('fieldLabels', {'Tipo de pr': 'header label - always visible', 'Dirección': 'header label - always visible', 'Telefono': 'header label - always visible', 'Imagen': 'no label', });
lyr_Ubicacionesrecientes_4.on('precompose', function(evt) {
